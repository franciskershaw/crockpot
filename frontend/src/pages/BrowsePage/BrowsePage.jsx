...
const BrowsePage = () => {
	...
	return (
		<>
			...
			<form
				action=""
				className="form container fixed top-0 left-0 right-0 z-search pt-nav-padding pb-4 bg-opacity-80 bg-grey-bg md:px-8 md:py-4 md:flex md:justify-center md:top-[108px] lg:top-[68px]"
			>
