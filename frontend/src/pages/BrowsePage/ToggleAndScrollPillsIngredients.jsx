...
const ToggleAndScrollPillsIngredients = ({ toggleTheme, scrollTheme, data, setFilters, filters, setModalOpen, filterType }) => {
...
export default ToggleAndScrollPillsIngredients;
