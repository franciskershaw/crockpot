...
const NavbarTop = () => {
	...
	return (
		<nav className="nav py-5 bg-primary border-b border-white fixed top-0 left-0 w-full flex justify-evenly z-nav shadow-navTop">
			<div className="container flex justify-between items-center w-full">
				<div className="flex items-center justify-between w-full">
					...
					<div className="hidden md:flex items-center space-x-2">
						{/* <Link href="/sandbox">
							<Button border text="Sandbox" inverse onClick={toggleMenu} />
						</Link> */}
						<Link href="/login">
							<Button
								border
